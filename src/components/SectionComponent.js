...
export default function SectionComponent() {
    ...
    <div>
        ...
        <div className='flex display-evenly flex-warp'>
        ...
        <div>
            <div className='flex display-between'>
                <p>Find out more content <br /> in our blog</p>
                <p>The most significant things we can think about, when we think about Apollo, is that it has opened for us, for us being the World, a challenge of the future. The door is now cracked, but the promise of that future lies in the young people, not just in America, but the young people all over the world. Learning to live and learning to work together.</p>
            </div>
            <div className='flex diplay-evenly'>
                <Carte4 image="img/" titre="Get started with AstroWind to create a website using astro and tailwind css" texte="The door is now cracked, but the promise of that future lies in the young people, not just in America, but the young people all over the world." />
                <Carte4 image="img/" titre="Usefool tools and resources to create a profesional website" texte="" />
                <Carte4 image="img/" titre="AstroWind template in depth" texte="The door is now cracked, but the promise of that future lies in the young people, not just in America, but the young people all over the world." />
                <Carte4 image="img/" titre="How to customize AstroWind template to suit your branding" texte="The door is now cracked, but the promise of that future lies in the young people, not just in America, but the young people all over the world." />
            </div>
        </div>
    </div>
    )
